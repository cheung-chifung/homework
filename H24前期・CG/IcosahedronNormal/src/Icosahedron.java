...
public class Icosahedron extends Object3D{
  ...
  private final float[] VertexData = new float[]{
    -1.0f, -1.0f,  -1f,  0.0f, 0.0f,-1.0f,   1f,0f,0f,1f,   0f,0f, //#0
     1.0f, -1.0f,  -1f,  0.0f, 0.0f,-1.0f,   1f,1f,0f,1f,   0f,0f, //#1
     1.0f,  1.0f,  -1f,  0.0f, 0.0f,-1.0f,   0f,1f,0f,1f,   0f,0f, //#2
    -1.0f,  1.0f,  -1f,  0.0f, 0.0f,-1.0f,   0f,0f,1f,1f,   0f,0f, //#3 
     1.0f, 1.0f,  1f,  0.0f, 0.0f,-1.0f,   1f,0f,0f,1f,   0f,0f, //#0
     1.0f, -1.0f,  1f,  0.0f, 0.0f,-1.0f,   1f,1f,0f,1f,   0f,0f, //#1
  ...
  */
  ...
  private FloatBuffer FBVertexData ;
  ...
  */
  ...
  private IntBuffer IBElementData;
  ...
  private void initIcosahedron(){
    float edge = 0.8f; // length of edge
    float se = edge/2; // short edge of rectangle
    float le = (float)((Math.sqrt(5)+1)/2 * se) ; // long edge = golden ration * short edge
    VertexData = new float[]{
        0.00f, -se, -le, 0.0f, -se,-le,   0.5f,0f,0f,1f,   1f,0f, 
        0.00f, -se, le, 0.0f, -se,le,   0.5f,0f,1f,1f,   1f,1f, 
        0.00f, se, -le, 0.0f, se, -le,   0.5f,1f,0f,1f,   0f,1f, 
        0.00f, se, le, 0.0f, se, le,   0.5f,1f,1f,1f,   0f,0f, 
        -se, -le, 0.00f, -se, -le, 0.0f,   0f,0f,0.5f,1f,   1f,0f, 
        -se, le, 0.00f, -se, le, 0.0f,   0f,1f,0.5f,1f,   1f,1f, 
        se, -le, 0.00f, se, -le, 0.0f,   1f,0f,0.5f,1f,   0f,1f, 
        se, le, 0.00f, se, le, 0.0f,   1f,1f,0.5f,1f,   0f,0f, 
        -le, 0.00f, -se, -le, 0.0f,-se,   0f,0.5f,0f,1f,   1f,0f, 
        le, 0.00f, -se, le, 0.0f,-se,   1f,0.5f,0f,1f,   1f,1f, 
        -le, 0.00f, se, -le, 0.0f,se,   0f,0.5f,1f,1f,   0f,1f, 
        le, 0.00f, se, le, 0.0f,se,   1f,0.5f,1f,1f,   0f,0f, 
    };//position            normal              color          texcoord
    ElementData = new int[]{
      6, 4, 0,
      6, 4, 1,
